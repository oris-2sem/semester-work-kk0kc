...
<div class="wrapper">
    ...
    <div class="content">
        <div class="container">
            ...
            <c:if test="${not empty forgot }">
                <div class="row">
                    <div class="col-md-offset-3 col-md-6">
                        <div class="alert alert-success">${forgot }</div>
                    </div>
                </div>
            </c:if>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <sf:form id="categoryForm" modelAttribute="category"
                        ...
                        <div class="form-group">
                            <label for="forgotpassword" class="col-md-4 control-label">Email
                                : </label>
                            <div class="col-md-8">
                                <input type="email" name="forgotpassword" class="form-control"/>
                            </div>
                        </div>
                        <center><div class="btn btn-primary" style="background: white">
                           <a href="${contextRoot }/login?forgot">Reset</a>
                        </div></center>
<%--                        <div class="form-group">--%>
<%--                            <div class="col-md-offset-4 col-md-8">--%>
